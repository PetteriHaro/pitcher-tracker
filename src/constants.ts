...
export const MOVEMENT_KEYS = [
  'spine', 'shoulders', 'hips', 'balance', 'core', 'inversions', 'breathing'
] as const
...
export const THROW_TYPE: Record<string, ThrowType> = {
  ...
  Wed: 'mound_bullpen',
  Thu: 'javelin_longtoss',
  Fri: 'mound_bullpen',
  Sat: 'javelin_longtoss',
  Sun: 'mound_bullpen',
}

export const GYM_DAYS = ['Tue', 'Fri']

export const INTENSITY_OPTIONS = ['60-70%', '70-80%', '80-90%', '90-100%'] as const
