...
import { parseISO, addDays, getMondayOfWeek, toISO, weekNumberFor } from './dates'
...
export function computeWeeklyStats(data: DayData, startDateISO: string): WeekStat[] {
...
export function computeAllTimeStats(weeklyStats: WeekStat[], data: DayData): AllTimeStats {
  let totalThrows = 0
  let totalMoveDays = 0
